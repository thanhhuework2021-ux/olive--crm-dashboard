      ...
      {displayedProducts.map((item) => (
        ...
        >
          ...
          <button
            ...
            className="mt-4 w-full rounded-lg bg-cyan-500 py-2 font-semibold text-black"
          >
            Thêm vào giỏ
          </button>
...
<div className="mt-4">
 ...
 <div className="mt-2 flex justify-between">
  ...
  <div className="mt-4 flex justify-between text-lg font-bold text-green-400">
...
<div className="mt-6 rounded-lg border bg-gray-50 p-4 text-[11px] leading-5">
  ...
  <p className="mt-2 font-semibold">
    Hỗ trợ đổi trả trong vòng 03 ngày nếu:
  </p>
